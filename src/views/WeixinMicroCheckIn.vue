    ...
    <div class="chenckin-info-body">
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="20%">
        ...
        <el-form-item prop="contactPhone" label="手机号码">
          ...
          <div class="tip">
            <span>手机号为商户自身能接收微信相关通知的号码，和客服电话可以相同也可以不一样</span>
          </div>
        </el-form-item>
...
export default {
  ...
  data () {
    ...
    // }
    return {
      uploadImgUrl: 'http://localhost:9090/api/admin/upload/uploadWeixinImg',
